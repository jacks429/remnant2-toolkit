...
export const traitItems: TraitItem[] = [
  ...
  },
  {
    ...
    description: `Archetype Summons absorb damage taken by the caster.`,
    maxLevelBonus: `At max level, Archetype Summons absorb 10% of damage taken by the caster.`,
  ...
  },
  {
    ...
    dlc: 'base',
    tags: ['Stagger'],
    description: `Reduces Hit Reaction Time`,
    maxLevelBonus: `At max level, Resolute Reduces Hit Reaction Time by 25%.`,
  ...
  },
  {
    ...
    dlc: 'base',
    tags: ['Neutral Dodge', 'Perfect Dodge', 'Perfect Neutral Evade'],
    description: `Increases Dodge Weight Threshold.`,
    maxLevelBonus: `At max level, Increases Dodge Weight Threshold by 15.`,
  ...
  },
  {
    ...
    dlc: 'base',
    tags: ['Movement Speed'],
    description: `Increases Movement Speed and increases Environmental Movement Speed.`,
    maxLevelBonus: `At max level, Increases Movement Speed by 15% and increases Environmental Movement Speed by 50%.`,
  ...
  },
  {
    ...
    maxLevelBonus: `At max level, Vigor Increases Maximum Health by 30.`,
